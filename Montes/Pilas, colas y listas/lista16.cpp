/*
16. Idem al Ej 15 pero el listado de alumnos por división debe realizarse ordenado creciente por
...
ST_NODO *insertOrdered(ST_DATO valor, ST_NODO **lista)
{
    ...
    while (listaAux != NULL && listaAux->alumno.division < valor.division && listaAux->alumno.legajo > valor.legajo)
    {
        nodoAnt = listaAux;
